      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Experience the power of better-auth with this comprehensive demo showcasing social
            providers, email/password authentication, and protected routes.
          </p>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100 hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">Social Authentication</h3>
            <p className="text-gray-600">
              Seamlessly authenticate users with Google, GitHub, and other popular social providers.
              No need to manage passwords or worry about security.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100 hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600">
              Traditional email and password authentication with secure password hashing, email
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100 hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">Secure & Protected</h3>
            <p className="text-gray-600">
              Built-in security features including JWT tokens, session management, and protected
        ...
        <div className="mt-20 bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-gray-900">Authentication Flow</h3>
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-indigo-100 rounded-full flex items-center justify-center">
                    <span className="text-xs font-medium text-indigo-600">1</span>
                  </div>
                  <span className="text-gray-700">Visit the authentication page</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-indigo-100 rounded-full flex items-center justify-center">
                    <span className="text-xs font-medium text-indigo-600">2</span>
                  </div>
                  <span className="text-gray-700">Choose your preferred sign-in method</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-indigo-100 rounded-full flex items-center justify-center">
                    <span className="text-xs font-medium text-indigo-600">3</span>
                  </div>
                  <span className="text-gray-700">Access the protected dashboard</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-gray-700">GitHub OAuth integration</span>
                </div>
                <div className="flex items-center space-x-2">
                  <svg
                    className="w-5 h-5 text-green-500"
        ...
        <div className="mt-20 text-center">
          <div className="bg-blue-50 rounded-2xl p-8 border border-blue-200">
            <h3 className="text-2xl font-bold text-blue-900 mb-4">About Better-Auth</h3>
            <p className="text-blue-800 text-lg mb-6">
              Better-Auth is a modern, flexible authentication library for Next.js that provides a
              seamless developer experience with built-in security and extensive customization
              options.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
